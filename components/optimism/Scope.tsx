import { ArrowDownIcon, ArrowUpIcon, AwardIcon, EqualIcon, Globe } from "lucide-react";
      ...
      <div className="bg-[#000317] p-6 group hover:bg-[#0A0F29] hover:shadow-lg transition-all duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#000108] rounded-lg p-6 border border-[#31695A] border-l-4 border-l-[#33C59E] min-h-[112px] min-w-[288px]">
            ...
            <ol className="text-white text-sm pl-8 leading-relaxed">
            <li>Minor misuse of Council-allocated funds with minimal financial impact.</li>
            <li>Easily correctable without significant consequences.</li>
            </ol>
          </div>
          ...
          <div className="bg-[#000108] rounded-lg p-6 border border-[#576933] border-l-4 border-l-[#A4DB3C] min-h-[112px] min-w-[288px]">
            ...
            <ol className="text-white text-sm pl-8 leading-relaxed">
            <li>Misuse that leads to inefficiencies in fund allocation or minor financial losses.</li>
            <li>Could result in limited disruption to approved initiatives but remains manageable.</li>
            </ol>
          </div>
          ...
          <div className="bg-[#000108] rounded-lg p-6 border border-[#663A2B] border-l-4 border-l-[#AC350D] min-h-[112px] min-w-[288px]">
            ...
            <ol className="text-white text-sm pl-8 leading-relaxed">
            <li>Significant misallocation of funds affecting multiple stakeholders.</li>
            <li>May compromise the intended purpose of the Council’s budget and require intervention.</li>
            </ol>
          </div>
        </div>
      </div>
