        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-6">
            <p className="text-gray-400 leading-relaxed">
              Please complete this short form and our Team will be in touch with
              you soon.
            </p>
            <p className="text-gray-400 leading-relaxed">
              Our Team will be able to discuss and answer any questions you may
              have regarding Truence and our services.
            </p>
          </div>
        </div>
      </div>
